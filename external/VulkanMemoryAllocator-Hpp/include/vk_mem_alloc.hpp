...
namespace VMA_HPP_NAMESPACE {
  template<class T>
  VULKAN_HPP_INLINE typename VULKAN_HPP_NAMESPACE::ResultValueType<typename std::decay<T>::type>::type createResultValueType(VULKAN_HPP_NAMESPACE::Result result, T&& value) {
    (void)result;
  ...
  VULKAN_HPP_INLINE void resultCheck(VULKAN_HPP_NAMESPACE::Result result, const char* message) {
#ifdef VULKAN_HPP_NO_EXCEPTIONS
    (void)message;
    assert(result == VULKAN_HPP_NAMESPACE::Result::eSuccess);
#else
